...
```{r}
pkgPath<- "/Users/Sepideh/Documents/Scripts/FreqUsedScripts/"
source(paste0(pkgPath, "RequiredPackagesMicroarrayAnanlysis.R"))

# source("http://bioconductor.org/biocLite.R")
# biocLite(c("GEOquery", "limma", "dplyr", "ggplot2", "edgeR", "RSubread", "affy", "matrixStats"))
# #add statmod and GO.db and org.Hs.eg.db package
# library(limma)
